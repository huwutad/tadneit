...
module.exports = {
    ...
    run: async (client, interaction, array) => {
        ...
        if (top[0].mods == '') osuMods = `Không mod`
        if (top[1].mods == '') osuMods = `Không mod`
        if (top[2].mods == '') osuMods = `Không mod`
        if (top[3].mods == '') osuMods = `Không mod`
        if (top[4].mods == '') osuMods = `Không mod`
